...
function ultra_filter_comment_fields($fields){
	...
	$fields['author'] = '<div class="comment-form-author"><input id="author" class="author-overlap" name="author" placeholder="' . esc_attr__('Name *', 'ultra') . '" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . $html_req . ' /></div>';
