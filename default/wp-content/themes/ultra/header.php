			...
			<nav id="site-navigation" class="main-navigation" role="navigation">
				...
				<?php if ( siteorigin_setting( 'navigation_menu_search' ) ) : ?>
					<div class="menu-search">
						...
						<form method="get" class="searchform-custom" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
							<input type="text" class="field" name="s" value="<?php echo esc_attr( get_search_query() ); ?>" placeholder="搜索..."/>
